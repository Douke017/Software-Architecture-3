/**
 * Runner oficial para el informe final de síntesis (report.md) usando Gemini API.
 * Compila el contexto global y genera report.md en la raíz de Week3 y en outputs/report.md.
 * 
 * Uso:
 *   $env:GEMINI_API_KEY="tu_api_key"
 *   node Week3/run_report.js [modelo]
 */
...
async function generate() {
  console.log(`[INFO] Compilando prompt de report.md en memoria con el marco de Microservicios...`);
  ...
  try {
    ...
    // Guardar en la raíz de Week3 y en outputs/
