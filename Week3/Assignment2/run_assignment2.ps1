<#
 ...
 .DESCRIPTION
    Ejecuta la compilación de Context Engineering y llama a Gemini API desde la carpeta Assignment2.
 .EXAMPLE
    .\run_assignment2.ps1
#>
...
if ($env:GEMINI_API_KEY -or $env:GOOGLE_API_KEY) {
    ...
    node "$ScriptDir\run_assignment2.js" $Model
} else {
    ...
    Write-Host "Y ejecuta: .\run_assignment2.ps1" -ForegroundColor White
}
