/**
 * Runner oficial usando la API de Gemini (Google AI Studio / Gemini API)
 * Procesa la compilación del prompt 100% en memoria y guarda la respuesta directa.
 * 
 * Uso:
 *   $env:GEMINI_API_KEY="tu_api_key_aqui"
 *   node Week3/run_with_api.js 1 [modelo]
 */
...
const outputFile = path.join(baseDir, 'outputs', `output${hitoNum}.md`);
...
async function generate() {
  console.log(`[INFO] Enviando prompt del Hito ${hitoNum} a Gemini API (Modelo: ${modelName})...`);
  ...
  try {
    ...
    // Guardar directamente sin sanitización
