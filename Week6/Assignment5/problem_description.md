# Descripción del Problema: Assignment 5 - Modelo C4 Extendido a Microservicios (MSA & EDA) (Week 6)
...
## Objetivo
Utilizando el Modelo C4, oriéntalo explícitamente a una **Arquitectura de Microservicios (MSA)** para este dominio guiado por eventos, identificando componentes como bases de datos (*Database-per-Service*), event buses, gateways y servicios autónomos a lo largo de los niveles C4 (Contexto, Contenedores y Componentes).
