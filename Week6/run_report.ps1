# Script PowerShell para ejecutar el Reporte Consolidado de la Semana 6 (QuickCart)
param (
    [string]$Model = "gemini-2.5-flash"
)

Write-Host "====================================================" -ForegroundColor Cyan
Write-Host " Context Engineering Automation - Week 6 Report" -ForegroundColor Cyan
