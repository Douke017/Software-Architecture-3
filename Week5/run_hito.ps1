<#
 .SYNOPSIS
    Script de Automatización para Context Engineering con Gemini (Semana 5).
 .DESCRIPTION
    Soporta la estructura automatizada de Week5:
      - hitos/ (Especificaciones brutas hito1.md, hito2.md, hito3.md)
      - hitos_prompted/ (Prompts guiados de arquitectura)
...
Write-Host " Context Engineering Automation - Week 5 (Hito $Hito)" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan
