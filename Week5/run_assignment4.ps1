<#
 ...
 .DESCRIPTION
    Ejecuta la compilación de Context Engineering y llama a Gemini API para Assignment 4.
 .EXAMPLE
    .\Week5\run_assignment4.ps1
#>
...
if ($env:GEMINI_API_KEY -or $env:GOOGLE_API_KEY) {
    ...
    node "$ScriptDir\Assignment4\run_assignment4.js" $Model
} else {
    ...
    Write-Host "Y ejecuta: .\Week5\run_assignment4.ps1" -ForegroundColor White
}
