/**
 * Runner oficial usando la API de Gemini (Google AI Studio / Gemini API) - Week 5
 * Procesa la compilación del prompt 100% en memoria y guarda la respuesta directa.
 * 
 * Uso:
 *   node Week5/run_with_api.js 1 [modelo]
 */
...
if (!apiKey) {
  ...
  console.error(`  export GEMINI_API_KEY="TU_API_KEY"\n`);
  process.exit(1);
}
...
async function generate() {
  console.log(`[INFO] Enviando prompt del Hito ${hitoNum} de la Semana 5 a Gemini API (Modelo: ${modelName})...`);
